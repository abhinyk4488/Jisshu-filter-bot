...
BOT_TOKEN = environ.get('BOT_TOKEN', '7667841659:AAE739zjCGSohQ9pOI_SPbxT2DyxcoXlaMg')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7142188712').split()]
USERNAME = environ.get('USERNAME', "https://t.me/KA15Supporter2") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002458171619'))
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb://colovo5146:colovo5146@<hostname>/?ssl=true&replicaSet=atlas-w8r7ub-shard-0&authSource=admin&retryWrites=true&w=majority&appName=Abhi44")
DATABASE_NAME = environ.get('DATABASE_NAME', "Abhi44")
